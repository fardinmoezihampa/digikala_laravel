    ...
    <div class="statbox widget box box-shadow">
        <div class="widget-header">
            <div class="d-flex justify-content-between align-items-center">
                    <h4>لیست محصولات</h4>
                    <a href="{{route('seller.product.create')}}" class="btn btn-outline-success mb-2 me-4">
                        افزودن محصول جدید
                    </a>
            </div>
        </div>
        <div class="widget-content widget-content-area">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('seller.product.features',$product->id)}}"
                                   class="btn btn-outline-info">ویژگی</a>
                            </td>
                            <td>
                                <a href="{{route('seller.product.content',$product->id)}}"
                ...
                {{@$products->links('layouts.seller.pagination')}}
            </div>
        </div>
    </div>
</div>
