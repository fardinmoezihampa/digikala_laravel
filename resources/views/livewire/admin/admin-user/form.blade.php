            ...
            <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" id="email" wire:model="email" name="email"
                               placeholder="">
                    </div>
                </div>
                @error('email')
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" id="mobile" wire:model="mobile" name="mobile" maxlength="11"
                               placeholder="">
                    </div>
                </div>
                @error('mobile')
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <select id="roles" class="form-control" wire:model="selectedRoles" multiple>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <select id="permission" class="form-control" wire:model="selectedPermissions" multiple>
