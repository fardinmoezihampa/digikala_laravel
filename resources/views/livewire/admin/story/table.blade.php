            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">تصویر بندانگشتی</th>
                    ...
                    @foreach($stories as $item)
                        <tr>
                            ...
                            <td>
                                <img src="/stories/thumbnail/{{$item->thumbnail}}" width="70" alt="">
                            </td>
                            <td>
                                <button data-story="/stories/story/{{$item->story}}" type="button"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="storyModalLabel">نمایش ویدئو</h5>
