        ...
        <div class="widget-content widget-content-area ecommerce-create-section">
            ...
            <div class="row mb-4">
                <div class="col-sm-12">
                    ...
                    <textarea type="text" class="form-control" id="meta_description" rows="4"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-4">
                            <div class="switch form-switch-custom switch-inline form-switch-danger">
                                <input class="switch-input" type="checkbox" name="featureId" role="switch"
                                       id="featureId">
                                <label class="switch-label" for="featureId">کالای ویژه</label>
                            </div>
                        </div>
                        <div class="col-sm-12">
