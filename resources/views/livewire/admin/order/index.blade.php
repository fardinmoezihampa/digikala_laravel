            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th width="200px" scope="col" class="text-center">تاریخ</th>
                        <th width="250px" scope="col" class="text-center">کاربر</th>
                    ...
                    @foreach($orders as $order)
                        <tr>
                            ...
                            <td class="text-center">
                                <span
                                    class="badge badge-{{$order->statusPaymentColor}}"> {{$order->payment->status}}</span>
                            </td>
                            <td class="text-center">
