<div>
    <section class="container my-5">
        <div class="w-100 d-flex align-items-center justify-content-between mb-3">
            ...
            <a href="/client" class="text-info fs-8">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center gap-4">
            <a href="/client" class="blog rounded-3 border d-flex flex-column">
                <img
                    src="/client/assets/blog/paris-olympics-opening-ceremony.jpg"
                    alt="paris-olympics-opening-ceremony"
                    class="rounded-top-3"/>
                <p class="fs-8 p-2 my-3 text-black">۸ لحظه‌ی غافلگیرانه در افتتاحیه المپیک پاریس که خبرساز شد</p>
            </a>
            <a href="/client" class="blog rounded-3 border d-flex flex-column">
                <img
                    ...
                    class="rounded-top-3"/>
                <p class="fs-8 p-2 my-3 text-black">گلکسی زد فولد ۶ اسلیم چندان باریک نخواهد بود</p>
            </a>
            <a href="/client" class="blog rounded-3 border d-flex flex-column">
                <img
                    ...
                    class="rounded-top-3"/>
                <p class="fs-8 p-2 my-3 text-black">آرایش با پوست مستعد آکنه چه ملاحظاتی دارد؟</p>
            </a>
            <a href="/client" class="blog rounded-3 border d-flex flex-column">
