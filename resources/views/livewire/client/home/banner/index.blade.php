<div>
    <section class="container my-4 bg-secondary-subtle rounded-4 superMarketSuggest overflow-hidden">
        <a href="/client" class="row align-items-center p-4">
            <div class="col-12 col-lg-5 d-flex flex-wrap align-items-center gap-3">
                <img src="/client/assets/imagePackage/fresh.webp" alt="fresh basket" class="d-none d-md-block"/>
                <img src="/client/assets/imagePackage/fresh-incredible-offer.svg" alt="fresh basket"/>
                <p class="fs-7 text-white bg-success px-3 py-2 rounded-5 mb-3 mx-auto mb-lg-0 mx-lg-0">تا 59% تخفیف</p>
            </div>
            <div class="col-12 col-lg-7 d-flex align-items-center justify-content-end gap-3">
