        ...
        <div class="cart-item">
            ...
            <div class="cart-item__footer d-flex align-items-center mt-3">
                ...
                <div class="cart-counter">
                    <button
                        {{$outOfStock ? 'disabled' : ''}} class="{{$outOfStock ? 'btn-disabled' : ''}} cart-counter__add"
                        wire:click="updateCartQuantity({{$item->id}},'increment')">
                ...
                <div class="cart-item__footer-price">
                    قیمت اصلی :<span class="cart-item__footer-new-price">
                  {{number_format($item->originalPrice)}} تومان
                </span>
                    <span class="cart-item__footer-discounted-price">
                 تخفیف : {{number_format($item->discountAmount)}} تومان
                </span>
                    قیمت نهایی:<span
                        class="cart-item__footer-new-price">{{number_format($item->discountedPrice)}}</span>
                    تومان
                </div>
            </div>
        </div>
