    ...
    <footer class="mt-5 border-top pt-5">
        <div class="container-fluid px-lg-5">
            ...
            <div class="d-none d-lg-flex row my-5">
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">اتاق خبر دیجی کالا</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">فروش در دیجی کالا</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">فرصت های شغلی</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">گزارش تخلف در دیجی کالا</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">تماس با دیجی کالا</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">درباره دیجی کالا</p></a>
                </div>

                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="my-3">خدمات مشتریان</h6>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">پاسخ به پرسش های متداول</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">رویه های بازگرداندن کالا</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">شرایط استفاده</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">حریم خصوصی</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">گزارش باگ</p></a>
                </div>

                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="my-3">راهنمای خرید از دیجی کالا</h6>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">نحوه ثبت سفارش</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">رویه ارسال سفارش</p></a>
                    <a href="/client" class="text-black-50 fs-7"><p class="my-2">شیوه های پرداخت</p></a>
                </div>

                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="my-3">همراه ما باشید!</h6>
                    <div class="d-flex flex-wrap align-items-center gap-5">
                        <a href="/client" class="text-black-50">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="35"
                                height="35"
            ...
            <div class="d-none d-lg-flex row mt-5">
                <div class="col-12 col-lg-6">
                    ...
                    <p class="text-wrap text-black-50">
                        ...
                        زمانی
                        کوتاه به دست مشتریان خود برساند و ضمانت بازگشت کالا هم داشته باشد؛ ویژگی‌هایی که فروشگاه اینترنتی
                        دیجی‌کالا سال‌هاست بر روی آن‌ها کار کرده و توانسته از این طریق مشتریان ثابت خود را داشته باشد.
                    </p>
                    <a href="/client" class="text-info">
                        <p class="fs-8 mt-2">
                            مشاهده بیشتر
                            <svg
                                width="14"
        ...
        <div class="subBrand px-5 d-lg-block d-none bg-secondary-subtle">
            <div class="d-flex align-items-center justify-content-center w-100">
                <a href="/client" class="border-start border-secondary-subtle">
