    ...
    <header class="container-fluid border-bottom" id="desktop-main-header">
        ...
        <div class="row py-4 mx-lg-4">
            <div class="col-12 col-lg-8 d-flex align-items-center column-gap-2">
                ...
                <div id="mSearchBox" class="bg-white w-100 h-100 pt-4 justify-content-center align-items-start">
        ...
        <div class="modal" id="desktopSearchBox" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header mx-0 border-bottom border-info justify-content-start gap-2">
                        <svg
                            width="20"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
            ...
            <div class="col-10">
                <ul class="d-flex align-items-center gap-3">
                    ...
                    <li class="d-flex flex-column overflow-hidden">
                        <a href="/client" class="d-flex align-items-center gap-1 text-black-50">
                <span>
                  <svg
                      width="15"
                      height="15"
