            ...
            <div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-12 field-wrapper">
                        ...
                        <input wire:model="postalCode" type="text" id="postalCode" name="postalCode" maxlength="10">
                        @error('postalCode')
                        <span class="validation-error">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 field-wrapper">
                        ...
                        <input wire:model="mobile" type="text" id="mobile" name="mobile" placeholder="09*****" maxlength="11">
                        @error('mobile')
                        <span class="validation-error">{{$message}}</span>
                        @enderror
                    </div>
