<div>
    <section id="details">
        ...
        <div id="content" class="mt-4">
                    ...
                    <div class="d-flex justify-content-between justify-content-lg-start me-5 gap-5">
                        ...
                        <div class="content-section w-100">
                            <div class="d-flex flex-column justify-content-start  gap-3 align-items-center flex-wrap">
                                @foreach($productFeartures as $item)
                                    <div class="d-flex flex-row gap-4 fs-8 text-secondary w-100">
                                        <p class="text-info-emphasis w-25">{{$item->categoryFeature->name}}</p>
            ...
            <!-- comments -->
            <div id="comment-content" class="content-div mx-lg-5 {{$activeTab==4 ? 'active':''}}">
                <div class="d-flex flex-column mb-3">
                ...
                <div class="content-section row">
                    ...
                    <div class="col col-lg-9">
                        ...
                        <div class="d-none d-lg-block mt-4">
                            <div class="d-flex gap-2">
                                <button type="button" class="btn border rounded-5 fs-8 fw-bold px-3 py-2">کیفیت و
                                    کارایی
                                </button>
                                <button type="button" class="btn border rounded-5 fs-8 fw-bold px-3 py-2">قیمت و ارزش
                                    خرید
                                </button>
                                <button type="button" class="btn border rounded-5 fs-8 fw-bold px-3 py-2">شباهت یا
                                    مغایرت
                                </button>
                            </div>
                            <p class="fs-9 text-secondary mt-3">این دسته‌بندی توسط هوش مصنوعی انجام شده و ممکن است دقیق
                                نباشد</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="my-4">
                                ...
                                <p>
                                    گوشی ناتیفنگ فون جنس بدنه و پشت گوشی خیلی خوبه کیفیت ال ای دی های نورش هم خوبه اما
                                    این گوشی حسی که
                                    ...
                                    بعنوان یک گوشی
                                    ۲۰ میلیونی بدون شارژر خوبه ولی برای خرید شارژر و گلس و قاب مناسب هم باید حدودا ۳ ۴ ت
                                    پول هزینه
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="d-flex align-items-start justify-content-center">
                                ...
                                <h5 class="fs-7 px-5">گوشی موبایل ناتینگ مدل Phone 2a ظرفیت 256 گیگابایت رم 12
                                    گیگابایت</h5>
                            </div>
                            <hr/>
